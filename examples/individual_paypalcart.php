...
$paypal->set('return', 'http://www.phplucidframe.com/sithu/GoPayPal?api=individual_paypalcart');
$paypal->set('cancel_return', 'http:///projects.sithukyaw.com/GoPayPal?api=individual_paypalcart');
