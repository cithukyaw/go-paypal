...
$paypal->set('return', 'http://projects.sithukyaw.com/GoPayPal/examples/index.php?api=individual_paypalcart');
$paypal->set('cancel_return', 'http:///projects.sithukyaw.com/GoPayPal/examples/index.php?api=individual_paypalcart');
