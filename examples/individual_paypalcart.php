...
$paypal->set('return', 'http://sithukyaw.com/GoPayPal/examples/index.php?api=individual_paypalcart');
$paypal->set('cancel_return', 'http:///sithukyaw.com/GoPayPal/examples/index.php?api=individual_paypalcart');
